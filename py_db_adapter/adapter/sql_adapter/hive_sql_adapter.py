...
__all__ = ("HiveSQLTableAdapter",)


class HiveSQLTableAdapter(sql_table_adapter.SqlTableAdapter):
    ...
    ) -> sql_column_adapter.StandardBooleanColumnSqlAdapter:
        return sql_column_adapter.StandardBooleanColumnSqlAdapter(
